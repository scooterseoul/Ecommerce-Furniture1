...
import styles from "./CategoryTables.module.css";
import discountHero from "../images/CAT-HERO-TABLEpexels-jonathan-borba-3285193.jpg";
    ...
    <div className={styles.mainCont}>
      <div className={styles.discountHero}>
        ...
        <div className={styles.subHeaderCont}>
          <p className={styles.subCopy}>STYLISH TABLES</p>
        ...
        <div className={styles.productListCont}>
          <ul className={styles.productGrid}>
            ...
            {productData
              .filter(
                (product) =>
                  product.metadata && product.metadata.type === "table"
              )
              .map((product) => (
