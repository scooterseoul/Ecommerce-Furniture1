...
import styles from "./CategoryAccessories.module.css";
import discountHero from "../images/CAT-HERO-ACCESSpexels-keegan-checks-12715591.jpg";
    ...
    <div className={styles.mainCont}>
      <div className={styles.discountHero}>
        ...
        <div className={styles.subHeaderCont}>
          <p className={styles.subCopy}>STYLISH ACCESSORIES</p>
          <p className={styles.subCopy2}>
            Check out some of our fabulous home decor accessories!
          </p>
        </div>
        <div className={styles.productListCont}>
          <ul className={styles.productGrid}>
            ...
            {productData
              .filter(
                (product) =>
                  product.metadata && product.metadata.type === "accessories"
              )
              .map((product) => (
